...
class RecommendationGenerator:
    ...
    def __init__(self):
        ...
        self.recommendation_map = {
            ...
            "DB_DESTRUCTIVE_CHANGE":
            [
                "Ensure backward compatibility",
                "Take database backups before applying",
                "Verify if the change is intended for production"
            ],
    ...
    def generate_for_finding(
        ...
        rule = finding.get("rule", finding.get("rule_name", ""))
